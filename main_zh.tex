...
\author{Dian Yu\\独立研究者\\\url{https://github.com/sdsds222/}}
\date{}
...
\input{sections_zh/serialization}
\input{sections_zh/architecture}
\input{sections_zh/algorithm}
\input{sections_zh/analysis}
\input{sections_zh/discussion}
\input{sections_zh/future_work}
